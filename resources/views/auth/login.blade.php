...
<head>
    ...
    <meta charset="utf-8">
    <title>Sign In | Sarinda . Artistry - Admin & Dashboard Template</title>
...
<body
    ...
    <div class="mb-0 border-none shadow-none xl:w-2/3 card bg-white/70 dark:bg-zink-500/70">
        <div class="grid grid-cols-1 gap-0 lg:grid-cols-12">
            ...
            <div class="mx-2 border-none shadow-none lg:col-span-7 card bg-white/60 dark:bg-zink-500/60">
