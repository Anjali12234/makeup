            ...
            <div class="lg:col-span-5">
                <div class="!px-12 !py-12 card-body">
                    ...
                    <div class="text-center">
                        ...
                        <p class="text-slate-500 dark:text-zink-200">Sign up to register.</p>
                    </div>
                    @if ($errors->any())
                ...
                <form method="POST" action="{{ route('customerRegister') }}" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="mb-3">
                            ...
                            <div id="password_confirmation-error" class="hidden mt-1 text-sm text-red-500">Password must be at least 8 characters long and contain both letters and numbers.</div>
                        </div>
                        ...
                        <div class="mt-10 text-center">
                            <p class="mb-0 text-slate-500 dark:text-zink-200">Already have account ? <a href="{{route('customerLogin')}}" class="font-semibold underline transition-all duration-150 ease-linear text-slate-500 dark:text-zink-200 hover:text-custom-500 dark:hover:text-custom-500"> Sign in</a> </p>
                        </div>
                    </form>
                </div>
            </div>
