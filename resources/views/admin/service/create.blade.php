...
@section('container')
                ...
                <div class="card-body">
                    ...
                    <form method="post" action="{{ route('admin.service.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="grid grid-cols-1 gap-x-5 md:grid-cols-2 xl:grid-cols-3">
                            ...
                            <x-input-label : id="price" value="{{ old('price') }}" title="Price"
                                spanClass="text-red-500" type="text" />
                            ...
                            <x-select id="category" value="{{ old('category') }}" title="Category" spanClass="text-white"
                                selected="old('category')" :list="\App\ServiceType::cases()" />
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <textarea name="description" id="editor" cols="50" rows="10">{{ old(key: 'description') }}</textarea>
    ...
    group-data-[layout=horizontal]:group-data-[navbar=hidden]:pt-[calc(theme('spacing.header')_*_0.9)]">
        <div class="container-fluid group-data-[content=boxed]:max-w-boxed mx-auto">
            <x-frontend.breadcumb : list="Service Category List" />
                            ...
                            <div class="relative xl:w-3/6">
                                ...
                                <i data-lucide="search"
                                    class="inline-block size-4 absolute ltr:left-2.5 rtl:right-2.5 top-2.5 text-slate-500 dark:text-zink-200
                                     fill-slate-100 dark:fill-zink-600" id="myInput" onkeyup="myFunction()"></i>
                            </div>
                        </div>
